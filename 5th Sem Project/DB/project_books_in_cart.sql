...
CREATE TABLE `books_in_cart` (
  ...
  PRIMARY KEY (`book_ISBN`,`customer_email`),
  KEY `fk_books_in_cart_books1_idx` (`book_ISBN`),
  KEY `fk_books_in_cart_customer1_idx` (`customer_email`),
  CONSTRAINT `fk_books_in_cart_customer1` FOREIGN KEY (`customer_email`) REFERENCES `customer` (`email`)
